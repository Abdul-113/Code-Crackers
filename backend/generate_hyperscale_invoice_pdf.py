...
def create_invoice_pdf(output_path):
    ...
    irn_box_data = [
        [
            ...
            Paragraph("<b>Ack No:</b> 1120267741982<br/><b>Ack Date:</b> 2026-08-07 16:45:10", ParagraphStyle('Ack', parent=styles['Normal'], fontSize=7.5, leading=10, textColor=colors.HexColor('#475569'), alignment=TA_RIGHT))
        ]
    ]
    ...
    # SELLER: HyperScale CyberSec Technologies Pvt. Ltd. (New)
    seller_html = """
    <b>Sold by / Vendor:</b><br/>
    <b>HyperScale CyberSec Technologies Pvt. Ltd.</b><br/>
    Level 5, Cyber Park, Sector 62, Electronic City<br/>
    Noida, Uttar Pradesh 201309<br/>
    <b>GSTIN:</b> 09AABCH3910L1Z2<br/>
    <b>PAN:</b> AABCH3910L | <b>State:</b> Uttar Pradesh (09)
    """
    ...
    meta_html = """
    <b>Invoice No:</b> HCS-2026-CYBER-742<br/>
    <b>Date of Invoice:</b> 07/08/2026<br/>
    <b>Payment Due Date:</b> 21/10/2026<br/>
    ...
    items = [
        [
            ...
            Paragraph("<b>Zero-Trust Enterprise SIEM & SOC Infrastructure</b><br/><font size='7.5' color='#64748B'>AI-Powered Log Ingestion & Threat Detection Hardware Appliance</font>", body_style),
            Paragraph("847150", body_style),
            Paragraph("1 Node", body_style),
            Paragraph("INR 35,00,000.00", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT)),
            Paragraph("INR 35,00,000.00", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT)),
        ],
        [
            Paragraph("2", body_style),
            Paragraph("<b>Automated Penetration Testing & Post-Quantum Encryption</b><br/><font size='7.5' color='#64748B'>Enterprise Gateway Encryption Suite & Automated Pentest License</font>", body_style),
        ...
        [
            ...
            Paragraph("<b>24/7 Red-Team Threat Intelligence & Incident Response Managed SLA</b><br/><font size='7.5' color='#64748B'>Dedicated security engineers SLA with 15-min emergency response</font>", body_style),
            Paragraph("998314", body_style),
            Paragraph("1 Qtr", body_style),
            Paragraph("INR 9,50,000.00", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT)),
            Paragraph("INR 9,50,000.00", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT)),
        ]
    ]
    ...
    summary_data = [
        [
            Paragraph("<b>Amount in Words:</b><br/>Rupees Seventy-Three Lakh Seventy-Five Thousand Only", body_style),
            Paragraph("<b>Subtotal / Taxable Value:</b>", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT)),
            Paragraph("INR 62,50,000.00", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT))
        ],
        [
            Paragraph("<b>Bank Account for Settlement:</b><br/>A/C: 924020058193821 | IFSC: UTIB0000240<br/>Bank: Axis Bank, Sector 62 Noida", body_style),
            Paragraph("<b>Integrated GST (IGST @ 18%):</b>", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT)),
            Paragraph("INR 11,25,000.00", ParagraphStyle('R', parent=body_style, alignment=TA_RIGHT))
        ],
        [
            ...
            Paragraph("<b>INR 73,75,000.00</b>", ParagraphStyle('R', parent=bold_body_style, fontSize=11, textColor=colors.HexColor('#059669'), alignment=TA_RIGHT))
        ]
    ]
    ...
    1. Payment is strictly due on or before <b>21/10/2026</b> as per contract terms.<br/>
    ...
    sign_html = """
    For <b>HyperScale CyberSec Technologies Pvt. Ltd.</b><br/><br/><br/>
...
if __name__ == "__main__":
    workspace_pdf = os.path.join(os.path.dirname(os.path.dirname(__file__)), "Sample_Invoice_Infosys_HyperScaleCyberSec.pdf")
    create_invoice_pdf(workspace_pdf)
    
    desktop_path = "C:/Users/saad2/Desktop/Sample_Invoice_Infosys_HyperScaleCyberSec.pdf"
    try:
